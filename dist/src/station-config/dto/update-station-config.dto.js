...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 5, description: 'Total number of tables available for guest artists' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 80, description: 'Price per table per day in EUR' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 10, description: 'Discount % applied when booking >= 30 days (default 10)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
