...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Creates a new consultation slot with a defined capacity. Clients can be assigned to available slots during the booking process.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns all consult slots with their capacity, remaining availability, and number of bookings assigned.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Permanently deletes a consult slot. Fails if any bookings are already assigned to this slot.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Assigns a specific consult slot to a booking request, decrementing the slot capacity. Sends a confirmation email to the client.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns all scheduled tattoo sessions for a specific booking request, ordered by date.',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'BookingRequest ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Updates the scheduled date, duration, station, or notes for a tattoo session.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Sets the tattoo session status to COMPLETED and sends a session reminder/follow-up email to the client.',
    }),
    (0, swagger_1.ApiParam)({ name: 'sessionId', description: 'Tattoo session ID' }),
