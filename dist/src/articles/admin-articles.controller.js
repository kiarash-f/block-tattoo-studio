...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Creates a new blog/news article in DRAFT status. The article is not publicly visible until published.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns a paginated list of all articles including drafts and unpublished items. Supports filtering by status and text search.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Updates article content, title, slug, or metadata fields. Optionally replaces the cover image.',
    }),
    (0, swagger_1.ApiConsumes)('multipart/form-data'),
    (0, swagger_1.ApiBody)({
        schema: {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Sets the article status to PUBLISHED and sets publishedAt to the current timestamp, making it publicly visible.',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Article ID (cuid)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Sets the article status back to DRAFT, removing it from public listings.',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Article ID (cuid)' }),
