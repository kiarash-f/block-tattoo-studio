...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns a paginated list of publicly visible (PUBLISHED) articles for the blog/news feed.',
    }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Paged list of published articles.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns a single published article by its URL slug. Returns 404 if the article is not found or not published.',
    }),
