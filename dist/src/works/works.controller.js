...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns all portfolio works for an artist, including draft and unpublished items. Supports filtering and pagination.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Updates metadata or publish status for a specific portfolio work. Use to publish/unpublish or retag a work.',
    }),
    (0, swagger_1.ApiParam)({ name: 'artistId', description: 'Artist ID (cuid)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Permanently deletes a portfolio work and its associated media files.',
    }),
    (0, swagger_1.ApiParam)({ name: 'artistId', description: 'Artist ID (cuid)' }),
    (0, swagger_1.ApiParam)({ name: 'workId', description: 'Work ID (cuid)' }),
