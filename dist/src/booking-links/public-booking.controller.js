...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get intake data via token (requires VIEW)', description: 'Returns the booking request intake data for the client associated with this token. Requires the VIEW scope.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid or expired token.' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Token lacks required INTAKE_CONTINUE scope.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Upload via token (requires UPLOAD)', description: 'Uploads reference or healed photos for a booking request using a tokenized link. Requires the UPLOAD scope.' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Files uploaded successfully.' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'No files provided or invalid file type.' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid or expired token.' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Token lacks required UPLOAD scope.' }),
