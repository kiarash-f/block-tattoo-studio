...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Creates a new bookable studio station (e.g. tattoo chair, consultation room).',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Sets the station status to INACTIVE. The station is excluded from scheduling but data is retained.',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Station ID (cuid)' }),
