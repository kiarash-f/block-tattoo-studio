...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Assigns an artist and/or studio station to a booking request for a specific session date.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns all artist/station assignments associated with the given booking request.',
    }),
    (0, swagger_1.ApiParam)({
        name: 'bookingRequestId',
        description: 'BookingRequest ID (uuid)',
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Updates the artist, station, or session details for an existing assignment.',
    }),
