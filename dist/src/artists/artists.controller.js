...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create new artist (multipart: cover + works)', description: 'Creates a new artist profile with optional cover image and portfolio work uploads. Accepts multipart/form-data.' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List artists with filtering and pagination', description: 'Returns a paginated list of artists. Supports filtering by status and searching by name or handle.' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get artist by ID', description: 'Returns full artist details including bio, status, cover image, and portfolio works.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Deactivate artist (soft delete)', description: 'Sets the artist status to INACTIVE. The artist is hidden from public listings but data is retained.' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Artist ID (cuid)' }),
