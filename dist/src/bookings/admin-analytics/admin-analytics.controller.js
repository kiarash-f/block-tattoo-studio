...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get analytics overview for a date range', description: 'Returns total bookings, breakdown by type and status, revenue metrics, and other summary statistics for the given date range.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Analytics timeseries for a date range', description: 'Returns daily booking counts over the specified date range, grouped by the requested interval.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Counts grouped by booking source', description: 'Returns booking counts broken down by referral source (e.g. instagram, google, walk-in) for the given date range.' }),
...
__decorate([
    (0, common_1.Get)('utm'),
    (0, swagger_1.ApiOperation)({ summary: 'Counts grouped by UTM dimension', description: 'Returns booking counts broken down by UTM campaign, source, or medium for the given date range.' }),
