...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Check in client on arrival', description: 'Marks the client as checked in to the studio. Sets checkedInAt timestamp and records which admin performed the check-in.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get in-studio medical and consent form', description: 'Returns the current state of the medical declaration and consent form for a booking. Returns null for each if not yet submitted.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Submit in-studio medical and consent form', description: 'Admin submits the medical declaration and consent form on behalf of the client during the studio visit. Overwrites any existing submission.' }),
