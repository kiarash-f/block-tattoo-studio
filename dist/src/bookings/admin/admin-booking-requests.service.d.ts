...
export declare class AdminBookingRequestsService {
    private readonly prisma;
    constructor(prisma: PrismaService);
    checkIn(bookingRequestId: string, adminId: string): Promise<({
        client: {
            id: string;
            email: string | null;
            createdAt: Date;
    ...
    getInStudioForm(bookingRequestId: string): Promise<{
        id: string;
        status: import("@prisma/client").$Enums.BookingStatus;
        checkedInAt: Date | null;
        inStudioCompletedAt: Date | null;
    ...
    submitInStudioForm(bookingRequestId: string, adminId: string, dto: SubmitInStudioFormDto): Promise<{
        booking: {
            client: {
                id: string;
                email: string | null;
