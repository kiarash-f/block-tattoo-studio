...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns paginated list of all booking requests. Filterable by status, search query, page, and limit.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: 'Walk-in created. Returns bookingId and upload token for tablet.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns full detail of a single booking request including client info, assignments, uploads, tattoo sessions, and scheduling.',
    }),
