...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns all bookings that have a PRIMARY assignment with a startsAt on the given date. Used for the admin daily schedule view. Requires date (YYYY-MM-DD) query param.',
    }),
