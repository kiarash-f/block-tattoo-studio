...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'startDate', required: true, example: '2026-06-01', description: 'ISO date YYYY-MM-DD' }),
    (0, swagger_1.ApiQuery)({ name: 'endDate', required: true, example: '2026-06-30', description: 'ISO date YYYY-MM-DD' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Booking created. Check shopifyCheckoutUrl for payment.' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Validation failed or not enough tables available.' }),
