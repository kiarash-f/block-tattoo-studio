...
export class ArtistsController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new artist profile with optional cover image and portfolio work uploads. Accepts multipart/form-data.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns a paginated list of artists. Supports filtering by status and searching by name or handle.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns full artist details including bio, status, cover image, and portfolio works.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Updates artist profile fields and optionally replaces the cover image or adds new portfolio works. Accepts multipart/form-data.',
  })
  @ApiConsumes('multipart/form-data')
  @UseInterceptors(
    FileFieldsInterceptor(
  ...
  @ApiOperation({
    ...
    description:
      'Sets the artist status to INACTIVE. The artist is hidden from public listings but data is retained.',
  })
  @ApiParam({ name: 'id', description: 'Artist ID (cuid)' })
