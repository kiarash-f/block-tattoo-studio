...
export class PublicArticlesController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns a paginated list of publicly visible (PUBLISHED) articles for the blog/news feed.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Returns a single published article by its URL slug. Returns 404 if the article is not found or not published.',
  })
